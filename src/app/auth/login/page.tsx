    ...
    <main className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="w-full max-w-md space-y-6 rounded-xl bg-surface border border-view1-border p-8">
        <div className="text-center">
          ...
          <h1 className="text-2xl font-bold text-white">Sign in to View1 Studio</h1>
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-3 rounded-lg border border-view1-border bg-surface px-4 py-2.5 text-sm font-medium text-white transition-colors hover:bg-white/5 disabled:cursor-not-allowed disabled:opacity-50"
        >
        ...
        <div className="flex items-center gap-3">
          <hr className="flex-1 border-view1-border" />
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between">
              ...
              <Link href="/auth/reset" className="text-xs text-accent hover:text-accent/80">
                Forgot password?
              </Link>
            </div>
            <input
